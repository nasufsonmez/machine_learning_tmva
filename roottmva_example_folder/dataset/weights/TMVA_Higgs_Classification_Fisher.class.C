...
{
   fFisher0 = 0.111600478825;
   fFisherCoefficients.push_back( -0.0480618326078 );
   fFisherCoefficients.push_back( 0.211831353401 );
   fFisherCoefficients.push_back( 0.0377528287429 );
   fFisherCoefficients.push_back( 0.0742721611001 );
   fFisherCoefficients.push_back( -0.190896111274 );
   fFisherCoefficients.push_back( 0.497328000822 );
   fFisherCoefficients.push_back( -0.75003360913 );
